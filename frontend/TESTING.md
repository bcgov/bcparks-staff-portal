...
Only pure functions in `src/lib/*.js` are covered so far — nothing that renders a
component, uses a hook, or touches the DOM. See
[src/lib/isDateTypeOptional.test.js](src/lib/isDateTypeOptional.test.js) for the
reference example.
