...
async function reSyncAll() {
  try {
    ...
    console.log("Starting: 1 - Delete all data...");
    await deleteAllData();
    console.log("Finished: 1 - Delete all data.\n");
    ...
    console.log(
      "Starting: 2 - Import Feature, FeatureType, Park, ParkArea, ManagementArea, Section from Strapi...",
    );
    await importData();
    console.log(
      "Finished: 2 - Import Feature, FeatureType, Park, ParkArea, ManagementArea, Section from Strapi.\n",
    );

    // 3 - import DateType from date-types.js
    console.log("Starting: 3 - Import DateType...");
    await createDateTypes();
    console.log("Finished: 3 - Import DateType.\n");

    // 4 - populate "hasWinterFeeDates" in Park from 2025-winter-parks.json
    console.log("Starting: 4 - Populate hasWinterFeeDates in Park...");
    await populateParkWinterFeeFlag();
    console.log("Finished: 4 - Populate hasWinterFeeDates in Park.\n");

    // 5 - populate "hasTier1Dates" and "hasTier2Dates" in Park from 2025-tier-data.json
    console.log(
      "Starting: 5 - Populate hasTier1Dates and hasTier2Dates in Park...",
    );
    await populateParkTierTypes();
    console.log(
      "Finished: 5 - Populate hasTier1Dates and hasTier2Dates in Park.\n",
    );

    // 6 - populate "inReservationSystem" in ParkArea
    console.log("Starting: 6 - Populate inReservationSystem in ParkArea...");
    await populateParkAreaInReservationSystem();
    console.log("Finished: 6 - Populate inReservationSystem in ParkArea.\n");

    // 7 - import AccessGroup, AccessGroupPark, UserAccessGroup from agreements-with-usernames.json
    console.log(
      "Starting: 7 - Import AccessGroup, AccessGroupPark, UserAccessGroup...",
    );
    await populateAccessGroups();
    console.log(
      "Finished: 7 - Import AccessGroup, AccessGroupPark, UserAccessGroup.\n",
    );

    // 8 - import GateDetail from Strapi park-operation and park-operation-sub-area
    console.log("Starting: 8 - Import GateDetail from Strapi...");
    await createGateDetailsFromStrapi();
    console.log("Finished: 8 - Import GateDetail from Strapi.\n");

    // 9 - create 2026 Seasons
    console.log("Starting: 9 - Create blank seasons for 2026...");
    await execAsync("node ./tasks/create-seasons.js 2026");
    console.log("Finished: 9 - Create blank seasons for 2026.\n");

    // 10 - import Season and DateRange from Strapi park-operation-sub-area-dates
    console.log("Starting: 10 - Import sub-area dates...");
    await importSubAreaDates();
    console.log("Finished: 10 - Import sub-area dates.\n");

    // 11 - import Season and DateRange from Strapi park-feature-dates
    console.log("Starting: 11 - Import park feature dates...");
    await importParkFeatureDates();
    console.log("Finished: 11 - Import park feature dates.\n");

    // 12 - import Season and DateRange from Strapi park-operation-dates
    console.log("Starting: 12 - Import park gate dates...");
    await populateParkGateDates();
    console.log("Finished: 12 - Import park gate dates.\n");

    // 13 - import Season and DateRange from previous-dates.json
    console.log("Starting: 13 - Import previous dates...");
    await populatePreviousDates();
    console.log("Finished: 13 - Import previous dates.\n");

    // 14 - import DateRangeAnnual from Strapi park-operation
    console.log("Starting: 14 - Import DateRangeAnnual...");
    await createDateRangeAnnualEntries();
    console.log("Finished: 14 - Import DateRangeAnnual.\n");

    console.log("All re-sync 14 steps completed.");
  } catch (err) {
